...
int main() {
  ...
  int populacao1= 0, populacao2 = 0;                  //Variáveis com a população
  ...
  printf("===================================================\n");
  printf("|          Bem-vindo ao Super Trunfo 0.2          |\n");
  printf("===================================================\n\n");
